...
(function() {
    var myCanvas,
        ...
        height,
        $mainwrap,
        pixel = window.devicePixelRatio || 3,
        pixW,
        pixH;
    ...
    function drawTip(x, y, n, r, color, data) {
        ...
        for (var i = 0, len = data.length; i < len; i++) {
            disx = Math.sin(data[i] * ang) * r;
            disy = -Math.cos(data[i] * ang) * r;
    ...
    function draw() {
        ...
        drawTip(width, height, polygon, radius, 'rgba(79,220,255,.8)', pageData.selData || [2, 6, 8]);
    }
